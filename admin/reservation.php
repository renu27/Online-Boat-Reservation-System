 ...
 <div class="container">
		...
		?>
					<tr>
						...
						<td class="align-img"><?php echo 'Rs '.number_format($bprice, 2); ?></td>
						<td class="align-img"><?php echo $st; ?></td>
						<td class="align-img">
							<a class = "btn btn-success btn-xs" href="edit.php?editid=<?php echo $r_id; ?>">
								Edit
