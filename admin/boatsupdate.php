				...
				<form action = "" method = "POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					    ...
					    <select name = "bC" class = "btn-lg" style = "width:250px;">
					    	<option <?php if($bcpcty == '5 Persons'){echo 'selected';} ?> value = "5 Persons">5 Persons</option>
					    	<option <?php if($bcpcty == '20 Persons'){echo 'selected';} ?> value = "20 Persons">20 Persons</option>
					    	<option <?php if($bcpcty == '50 Persons'){echo 'selected';} ?> value = "50 Persons">50 Persons</option>
							<option <?php if($bcpcty == '100 Persons'){echo 'selected';} ?> value = "100 Persons">100 Persons</option>
							<option <?php if($bcpcty == '500 Persons'){echo 'selected';} ?> value = "500 Persons">500 Persons</option>
						</select>
					  </div>
